...
public class WordCount {
	...
	private List<KeyValuePair<String, Integer>> processWordCount(Path file) {
	...
	private List<KeyValuePair<String, Integer>> map(String rawToken) {
	...
	private void printData(List<KeyValuePair<String, Integer>> list) {
		if (list != null) {
	...
	public static void main(String[] args) {
		...
		List<KeyValuePair<String, Integer>> list = wc.processWordCount(file);
		wc.printData(list);
	}
